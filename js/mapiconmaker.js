...
MapIconMaker.createMarkerIcon = function (opts) {
  ...
  var pinStyle = opts.pinStyle || "pin_star";
  var pinType = opts.pinType || "d_map_pin_letter";
  var baseUrl = "http://chart.apis.google.com/chart?";
  var charts_url = "";
  if (pinType === "d_map_pin_letter"){
     charts_url = baseUrl + "chst="+pinType+"&chld=|" +
                             primaryColor.replace("#", "") +
                             "|000000";
  }
  else if(pinType === "d_map_xpin_letter"){
     charts_url = baseUrl + "chst="+pinType+"&chld="+pinStyle+"||" +
                             primaryColor.replace("#", "") +
                             "|B8860B|B8860B";
  }
  return charts_url;
